...
def main():
    ...
    res_url_base = "/code/modulus/examples/generative/corrdiff/outputs/generation/hurricane_2022_10M.nc"
    ...
    output_dir = "/code/modulus/examples/generative/corrdiff/output_metrics/plot_samples_10m"#os.path.splitext(__file__)[0]
    ...
    writer = imageio.get_writer('/code/modulus/examples/generative/corrdiff/output_metrics/radar_reflectivity_movie_10m.mp4', fps = 3)
