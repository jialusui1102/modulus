...
GENERATE_FILENAME = "hurricane_2022_10M.nc"
SCORES_FILENAME = "score.nc"
...
def main(run: str, step: int=typer.Option(), inferences: str=inference_root, scores: str= score_root, inference_type: str = "", rank_hist: bool = False):
    """
    Example:
        6m patched-diffusion: 1177517
        10m patched-diffusion: 1216822
        ./score.py --step 103614 paper_diffusion --inference-type large_validation_2023
        python3 score.py patched_diffusion --step 1177517 
        python /code/modulus/examples/generative/corrdiff/score.py patched_diffusion --step 1216822 --rank-hist
    """
    ...
    if rank_hist:
        ...
        # call_python_script(["/code/modulus/examples/generative/corrdiff/inference_old/rank_histogram.py", path_netcdf, os.path.join(dirname, "dispersion"), "--n-ensemble", "32", "--n-timesteps", "10"])
